...
resource "google_bigquery_table" "training_plan_versions" {
  ...
  schema = jsonencode([
    ...
    { name = "plan_rationale", type = "STRING", mode = "NULLABLE" },
...
resource "google_bigquery_table" "planned_workouts" {
  ...
  schema = jsonencode([
    ...
    { name = "scheduled_start_local_time", type = "TIME", mode = "NULLABLE" },
    { name = "availability_slot_id", type = "STRING", mode = "NULLABLE" },
    ...
    { name = "outdoors", type = "BOOLEAN", mode = "NULLABLE" },
    { name = "split_allowed", type = "BOOLEAN", mode = "NULLABLE" },
    { name = "environment_ids", type = "STRING", mode = "REPEATED" },
...
resource "google_bigquery_table" "workout_reconciliations" {
  ...
  schema = jsonencode([
    ...
    { name = "status", type = "STRING", mode = "REQUIRED" },
    { name = "candidate_planned_workout_ids", type = "STRING", mode = "REPEATED" },
    { name = "match_confidence", type = "FLOAT", mode = "NULLABLE" },
    { name = "matching_evidence", type = "STRING", mode = "REPEATED" },
    { name = "confirmed", type = "BOOLEAN", mode = "NULLABLE" },
    ...
    { name = "manual_correction", type = "BOOLEAN", mode = "NULLABLE" },
    { name = "correction_reason", type = "STRING", mode = "NULLABLE" },
    { name = "supersedes_reconciliation_id", type = "STRING", mode = "NULLABLE" },
